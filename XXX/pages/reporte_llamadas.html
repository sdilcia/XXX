    ...
    <section class="banner-area" id="home">
        ...
        <div class="bg-contact2" style="background-image: url('../img/cacao2.jpg');">
            <div class="container-contact2">
                <div class="wrap-contact2" style="margin-top: 252px;width: 788.656px;height: 862px;padding-right: 55px;margin-right: 150px;border-right-width: 10px;">
                    ...
                    <div>
                        ...
                        <object data="../Lean Development (1).pdf" type="application/pdf" width="100%" height="100%" style="width: 725px;height: 600px;padding-right: 50px;"
                        />
