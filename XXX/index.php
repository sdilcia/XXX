				...
				<section class="banner-area" id="home">	
					<div class="container">
						<div class="row fullscreen d-flex align-items-center justify-content-start">
							<div class="banner-content col-lg-7" ><br>
								<h1>
									Bienvenidos a<br>
					...
					<div class="container">
						<div class="row d-flex justify-content-center">
							<div class="menu-content pb-60 col-lg-10">
								...
								<h1 class="mb-10">Elije ser feliz con el Cacao</h1>
								</div>
							</div>
						</div>
						...
						<div class="row">
						<div class="col-lg-4">
							<a href="img/istock.jpg" class="img-pop-home">
								<img class="img-fluid" src="img/istock.jpg" alt="">
							</a>	
							<a href="img/el-cacao-es-un-superalimento.jpg" class="img-pop-home">
								<img class="img-fluid" src="img/el-cacao-es-un-superalimento.jpg" alt="">
							</a>	
						</div>
						<div class="col-lg-8">
							<a href="img/b2.jpg" class="img-pop-home">
								<img class="img-fluid" src="img/b2.jpg" alt="">
							</a>	
							<div class="row">
								<div class="col-lg-6">
									<a href="img/cacao1.jpg" class="img-pop-home">
										<img class="img-fluid" src="img/cacao1.jpg" alt="">
									</a>	
								</div>
								<div class="col-lg-6">
									<a href="img/productor.jpg" class="img-pop-home">
										<img class="img-fluid" src="img/productor.jpg" alt="">
									</a>	
								</div>
							</div>
						</div>
			...
			<footer class="footer-area section-gap" id="footerSection">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="single-footer-widget"></div>
						<p class="footer-text">									
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <br> Estudiantes UNAH <br>
							 INGENIERIA DEL SOFTWARE</a>
						</p>								
					</div>
				</div>												
			</footer>		
